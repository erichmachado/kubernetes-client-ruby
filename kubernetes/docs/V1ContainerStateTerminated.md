...
| **finished_at** | **Time** | Time at which the container last terminated | [optional] |
...
| **started_at** | **Time** | Time at which previous execution of the container started | [optional] |
...
instance = Kubernetes::V1ContainerStateTerminated.new(
  container_id: null,
  exit_code: null,
  finished_at: null,
  message: null,
