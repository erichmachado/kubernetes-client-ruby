...
| **sources** | [**Array&lt;V1VolumeProjection&gt;**](V1VolumeProjection.md) | sources is the list of volume projections. Each entry in this list handles one source. | [optional] |
...
instance = Kubernetes::V1ProjectedVolumeSource.new(
  default_mode: null,
  sources: null
)
```
