...
| **ports** | [**Array&lt;CoreV1EndpointPort&gt;**](CoreV1EndpointPort.md) | Port numbers available on the related IP addresses. | [optional] |
...
instance = Kubernetes::V1EndpointSubset.new(
  addresses: null,
