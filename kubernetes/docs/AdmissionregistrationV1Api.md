...
begin
  ...
  puts "Error when calling AdmissionregistrationV1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1Api->get_api_resources_with_http_info: #{e}"
end
```
