# Kubernetes::CoordinationV1alpha1Api
...
> <V1alpha1LeaseCandidate> create_namespaced_lease_candidate(namespace, body, opts)
...
api_instance = Kubernetes::CoordinationV1alpha1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1alpha1LeaseCandidate.new # V1alpha1LeaseCandidate | 
opts = {
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->create_namespaced_lease_candidate: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidate>, Integer, Hash)> create_namespaced_lease_candidate_with_http_info(namespace, body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1LeaseCandidate>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1alpha1Api->create_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->delete_collection_namespaced_lease_candidate: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->delete_collection_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->delete_namespaced_lease_candidate: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->delete_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->get_api_resources_with_http_info: #{e}"
end
```
...
> <V1alpha1LeaseCandidateList> list_lease_candidate_for_all_namespaces(opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->list_lease_candidate_for_all_namespaces: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidateList>, Integer, Hash)> list_lease_candidate_for_all_namespaces_with_http_info(opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1LeaseCandidateList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1alpha1Api->list_lease_candidate_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1alpha1LeaseCandidateList> list_namespaced_lease_candidate(namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->list_namespaced_lease_candidate: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidateList>, Integer, Hash)> list_namespaced_lease_candidate_with_http_info(namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->list_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
> <V1alpha1LeaseCandidate> patch_namespaced_lease_candidate(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->patch_namespaced_lease_candidate: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidate>, Integer, Hash)> patch_namespaced_lease_candidate_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->patch_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
> <V1alpha1LeaseCandidate> read_namespaced_lease_candidate(name, namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->read_namespaced_lease_candidate: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidate>, Integer, Hash)> read_namespaced_lease_candidate_with_http_info(name, namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->read_namespaced_lease_candidate_with_http_info: #{e}"
end
```
...
> <V1alpha1LeaseCandidate> replace_namespaced_lease_candidate(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->replace_namespaced_lease_candidate: #{e}"
end
```
...
> <Array(<V1alpha1LeaseCandidate>, Integer, Hash)> replace_namespaced_lease_candidate_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1alpha1Api->replace_namespaced_lease_candidate_with_http_info: #{e}"
end
```
