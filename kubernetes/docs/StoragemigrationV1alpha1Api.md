...
> <V1alpha1StorageVersionMigration> create_storage_version_migration(body, opts)
...
api_instance = Kubernetes::StoragemigrationV1alpha1Api.new
body = Kubernetes::V1alpha1StorageVersionMigration.new # V1alpha1StorageVersionMigration | 
opts = {
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->create_storage_version_migration: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> create_storage_version_migration_with_http_info(body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1StorageVersionMigration>
rescue Kubernetes::ApiError => e
  puts "Error when calling StoragemigrationV1alpha1Api->create_storage_version_migration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->delete_collection_storage_version_migration: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->delete_collection_storage_version_migration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->delete_storage_version_migration: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->delete_storage_version_migration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->get_api_resources_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigrationList> list_storage_version_migration(opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->list_storage_version_migration: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigrationList>, Integer, Hash)> list_storage_version_migration_with_http_info(opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1StorageVersionMigrationList>
rescue Kubernetes::ApiError => e
  puts "Error when calling StoragemigrationV1alpha1Api->list_storage_version_migration_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> patch_storage_version_migration(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->patch_storage_version_migration: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> patch_storage_version_migration_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->patch_storage_version_migration_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> patch_storage_version_migration_status(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->patch_storage_version_migration_status: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> patch_storage_version_migration_status_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->patch_storage_version_migration_status_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> read_storage_version_migration(name, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->read_storage_version_migration: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> read_storage_version_migration_with_http_info(name, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->read_storage_version_migration_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> read_storage_version_migration_status(name, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->read_storage_version_migration_status: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> read_storage_version_migration_status_with_http_info(name, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->read_storage_version_migration_status_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> replace_storage_version_migration(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->replace_storage_version_migration: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> replace_storage_version_migration_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->replace_storage_version_migration_with_http_info: #{e}"
end
```
...
> <V1alpha1StorageVersionMigration> replace_storage_version_migration_status(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->replace_storage_version_migration_status: #{e}"
end
```
...
> <Array(<V1alpha1StorageVersionMigration>, Integer, Hash)> replace_storage_version_migration_status_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StoragemigrationV1alpha1Api->replace_storage_version_migration_status_with_http_info: #{e}"
end
```
