...
body = Kubernetes::V1beta1TokenReview.new({spec: Kubernetes::V1beta1TokenReviewSpec.new}) # V1beta1TokenReview | 
opts = {
...
begin
  ...
  puts "Error when calling AuthenticationV1beta1Api->create_token_review: #{e}"
end
```
...
> <Array(<V1beta1TokenReview>, Integer, Hash)> create_token_review_with_http_info(body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1beta1TokenReview>
rescue Kubernetes::ApiError => e
  puts "Error when calling AuthenticationV1beta1Api->create_token_review_with_http_info: #{e}"
end
```
