...
> <V1beta1SelfSubjectReview> create_self_subject_review(body, opts)
...
body = Kubernetes::V1beta1SelfSubjectReview.new # V1beta1SelfSubjectReview | 
opts = {
...
begin
  ...
  puts "Error when calling AuthenticationV1beta1Api->create_self_subject_review: #{e}"
end
```
...
> <Array(<V1beta1SelfSubjectReview>, Integer, Hash)> create_self_subject_review_with_http_info(body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1beta1SelfSubjectReview>
rescue Kubernetes::ApiError => e
  puts "Error when calling AuthenticationV1beta1Api->create_self_subject_review_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AuthenticationV1beta1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AuthenticationV1beta1Api->get_api_resources_with_http_info: #{e}"
end
```
