...
> <V1alpha1VolumeAttributesClass> create_volume_attributes_class(body, opts)
...
api_instance = Kubernetes::StorageV1alpha1Api.new
body = Kubernetes::V1alpha1VolumeAttributesClass.new({driver_name: 'driver_name_example'}) # V1alpha1VolumeAttributesClass | 
opts = {
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->create_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClass>, Integer, Hash)> create_volume_attributes_class_with_http_info(body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1VolumeAttributesClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling StorageV1alpha1Api->create_volume_attributes_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->delete_collection_volume_attributes_class: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->delete_collection_volume_attributes_class_with_http_info: #{e}"
end
```
...
> <V1alpha1VolumeAttributesClass> delete_volume_attributes_class(name, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->delete_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClass>, Integer, Hash)> delete_volume_attributes_class_with_http_info(name, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->delete_volume_attributes_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->get_api_resources_with_http_info: #{e}"
end
```
...
> <V1alpha1VolumeAttributesClassList> list_volume_attributes_class(opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->list_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClassList>, Integer, Hash)> list_volume_attributes_class_with_http_info(opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1VolumeAttributesClassList>
rescue Kubernetes::ApiError => e
  puts "Error when calling StorageV1alpha1Api->list_volume_attributes_class_with_http_info: #{e}"
end
```
...
> <V1alpha1VolumeAttributesClass> patch_volume_attributes_class(name, body, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->patch_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClass>, Integer, Hash)> patch_volume_attributes_class_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->patch_volume_attributes_class_with_http_info: #{e}"
end
```
...
> <V1alpha1VolumeAttributesClass> read_volume_attributes_class(name, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->read_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClass>, Integer, Hash)> read_volume_attributes_class_with_http_info(name, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->read_volume_attributes_class_with_http_info: #{e}"
end
```
...
> <V1alpha1VolumeAttributesClass> replace_volume_attributes_class(name, body, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->replace_volume_attributes_class: #{e}"
end
```
...
> <Array(<V1alpha1VolumeAttributesClass>, Integer, Hash)> replace_volume_attributes_class_with_http_info(name, body, opts)
...
begin
  ...
  puts "Error when calling StorageV1alpha1Api->replace_volume_attributes_class_with_http_info: #{e}"
end
```
