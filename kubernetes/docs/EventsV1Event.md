...
| **deprecated_first_timestamp** | **Time** | deprecatedFirstTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type. | [optional] |
| **deprecated_last_timestamp** | **Time** | deprecatedLastTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type. | [optional] |
| **deprecated_source** | [**V1EventSource**](V1EventSource.md) |  | [optional] |
| **event_time** | **Time** | eventTime is the time when this Event was first observed. It is required. |  |
...
instance = Kubernetes::EventsV1Event.new(
  action: null,
  api_version: null,
