...
| **deprecated_first_timestamp** | **Time** | Deprecated field assuring backward compatibility with core.v1 Event type | [optional] |
| **deprecated_last_timestamp** | **Time** | Deprecated field assuring backward compatibility with core.v1 Event type | [optional] |
| **deprecated_source** | [**V1EventSource**](V1EventSource.md) |  | [optional] |
| **event_time** | **Time** | Required. Time when this Event was first observed. |  |
...
instance = Kubernetes::V1beta1Event.new(
  action: null,
  api_version: null,
