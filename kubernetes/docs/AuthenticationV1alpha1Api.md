# Kubernetes::AuthenticationV1alpha1Api
...
> <V1alpha1SelfSubjectReview> create_self_subject_review(body, opts)
...
api_instance = Kubernetes::AuthenticationV1alpha1Api.new
body = Kubernetes::V1alpha1SelfSubjectReview.new # V1alpha1SelfSubjectReview | 
opts = {
...
begin
  ...
  puts "Error when calling AuthenticationV1alpha1Api->create_self_subject_review: #{e}"
end
```
...
> <Array(<V1alpha1SelfSubjectReview>, Integer, Hash)> create_self_subject_review_with_http_info(body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1SelfSubjectReview>
rescue Kubernetes::ApiError => e
  puts "Error when calling AuthenticationV1alpha1Api->create_self_subject_review_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AuthenticationV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AuthenticationV1alpha1Api->get_api_resources_with_http_info: #{e}"
end
```
