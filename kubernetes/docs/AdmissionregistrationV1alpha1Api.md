...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->create_initializer_configuration: #{e}"
end
```

#### Using the create_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1alpha1InitializerConfiguration>, Integer, Hash)> create_initializer_configuration_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_initializer_configuration_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1InitializerConfiguration>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->create_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->delete_collection_initializer_configuration: #{e}"
end
```

#### Using the delete_collection_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_initializer_configuration_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_initializer_configuration_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->delete_collection_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->delete_initializer_configuration: #{e}"
end
```

#### Using the delete_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_initializer_configuration_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_initializer_configuration_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->delete_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->list_initializer_configuration: #{e}"
end
```

#### Using the list_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1alpha1InitializerConfigurationList>, Integer, Hash)> list_initializer_configuration_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_initializer_configuration_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1InitializerConfigurationList>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->list_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->patch_initializer_configuration: #{e}"
end
```

#### Using the patch_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1alpha1InitializerConfiguration>, Integer, Hash)> patch_initializer_configuration_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_initializer_configuration_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1InitializerConfiguration>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->patch_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->read_initializer_configuration: #{e}"
end
```

#### Using the read_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1alpha1InitializerConfiguration>, Integer, Hash)> read_initializer_configuration_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_initializer_configuration_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1InitializerConfiguration>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->read_initializer_configuration_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AdmissionregistrationV1alpha1Api->replace_initializer_configuration: #{e}"
end
```

#### Using the replace_initializer_configuration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1alpha1InitializerConfiguration>, Integer, Hash)> replace_initializer_configuration_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_initializer_configuration_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1InitializerConfiguration>
rescue Kubernetes::ApiError => e
  puts "Error when calling AdmissionregistrationV1alpha1Api->replace_initializer_configuration_with_http_info: #{e}"
end
```
