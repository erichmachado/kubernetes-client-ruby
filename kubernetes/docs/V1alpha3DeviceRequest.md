# Kubernetes::V1alpha3DeviceRequest
...
| **selectors** | [**Array&lt;V1alpha3DeviceSelector&gt;**](V1alpha3DeviceSelector.md) | Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this request. All selectors must be satisfied for a device to be considered. | [optional] |
...
instance = Kubernetes::V1alpha3DeviceRequest.new(
  admin_access: null,
