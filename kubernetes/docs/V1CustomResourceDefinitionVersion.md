...
| **selectable_fields** | [**Array&lt;V1SelectableField&gt;**](V1SelectableField.md) | selectableFields specifies paths to fields that may be used as field selectors. A maximum of 8 selectable fields are allowed. See https://kubernetes.io/docs/concepts/overview/working-with-objects/field-selectors | [optional] |
...
instance = Kubernetes::V1CustomResourceDefinitionVersion.new(
