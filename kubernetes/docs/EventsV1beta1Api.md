...
> <V1beta1Event> create_namespaced_event(namespace, body, opts)
...
api_instance = Kubernetes::EventsV1beta1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1beta1Event.new({event_time: Time.now}) # V1beta1Event | 
opts = {
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->create_namespaced_event: #{e}"
end
```
...
> <Array(<V1beta1Event>, Integer, Hash)> create_namespaced_event_with_http_info(namespace, body, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->create_namespaced_event_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->delete_collection_namespaced_event: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->delete_collection_namespaced_event_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->delete_namespaced_event: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->delete_namespaced_event_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->get_api_resources_with_http_info: #{e}"
end
```
...
> <V1beta1EventList> list_event_for_all_namespaces(opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->list_event_for_all_namespaces: #{e}"
end
```
...
> <Array(<V1beta1EventList>, Integer, Hash)> list_event_for_all_namespaces_with_http_info(opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1beta1EventList>
rescue Kubernetes::ApiError => e
  puts "Error when calling EventsV1beta1Api->list_event_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1beta1EventList> list_namespaced_event(namespace, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->list_namespaced_event: #{e}"
end
```
...
> <Array(<V1beta1EventList>, Integer, Hash)> list_namespaced_event_with_http_info(namespace, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->list_namespaced_event_with_http_info: #{e}"
end
```
...
> <V1beta1Event> patch_namespaced_event(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->patch_namespaced_event: #{e}"
end
```
...
> <Array(<V1beta1Event>, Integer, Hash)> patch_namespaced_event_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->patch_namespaced_event_with_http_info: #{e}"
end
```
...
> <V1beta1Event> read_namespaced_event(name, namespace, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->read_namespaced_event: #{e}"
end
```
...
> <Array(<V1beta1Event>, Integer, Hash)> read_namespaced_event_with_http_info(name, namespace, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->read_namespaced_event_with_http_info: #{e}"
end
```
...
> <V1beta1Event> replace_namespaced_event(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->replace_namespaced_event: #{e}"
end
```
...
> <Array(<V1beta1Event>, Integer, Hash)> replace_namespaced_event_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling EventsV1beta1Api->replace_namespaced_event_with_http_info: #{e}"
end
```
