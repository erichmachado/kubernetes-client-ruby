...
> <V1beta1Lease> create_namespaced_lease(namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->create_namespaced_lease: #{e}"
end
```
...
> <Array(<V1beta1Lease>, Integer, Hash)> create_namespaced_lease_with_http_info(namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->create_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->delete_collection_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->delete_collection_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->delete_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->delete_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->get_api_resources_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->list_lease_for_all_namespaces: #{e}"
end
```
...
> <Array(<V1beta1LeaseList>, Integer, Hash)> list_lease_for_all_namespaces_with_http_info(opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1beta1LeaseList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1beta1Api->list_lease_for_all_namespaces_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->list_namespaced_lease: #{e}"
end
```
...
> <Array(<V1beta1LeaseList>, Integer, Hash)> list_namespaced_lease_with_http_info(namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->list_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->patch_namespaced_lease: #{e}"
end
```
...
> <Array(<V1beta1Lease>, Integer, Hash)> patch_namespaced_lease_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->patch_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->read_namespaced_lease: #{e}"
end
```
...
> <Array(<V1beta1Lease>, Integer, Hash)> read_namespaced_lease_with_http_info(name, namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->read_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->replace_namespaced_lease: #{e}"
end
```
...
> <Array(<V1beta1Lease>, Integer, Hash)> replace_namespaced_lease_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1beta1Api->replace_namespaced_lease_with_http_info: #{e}"
end
```
