...
| **extra** | **Hash&lt;String, Array&lt;String&gt;&gt;** | extra contains extra attributes of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable. | [optional] |
| **groups** | **Array&lt;String&gt;** | groups contains group membership of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable. | [optional] |
...
instance = Kubernetes::V1CertificateSigningRequestSpec.new(
