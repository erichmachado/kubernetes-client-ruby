...
module Kubernetes
  class SettingsV1alpha1Api
    ...
    def create_namespaced_pod_preset(namespace, body, opts = {})
      data, _status_code, _headers = create_namespaced_pod_preset_with_http_info(namespace, body, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1PodPreset, Integer, Hash)>] V1alpha1PodPreset data, response status code and response headers
    def create_namespaced_pod_preset_with_http_info(namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.create_namespaced_pod_preset ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SettingsV1alpha1Api.create_namespaced_pod_preset"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1PodPreset'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.create_namespaced_pod_preset",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#create_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [V1Status]
    def delete_collection_namespaced_pod_preset(namespace, opts = {})
      data, _status_code, _headers = delete_collection_namespaced_pod_preset_with_http_info(namespace, opts)
      data
    end
    ...
    def delete_collection_namespaced_pod_preset_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.delete_collection_namespaced_pod_preset ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.delete_collection_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#delete_collection_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # delete a PodPreset
    # @param name [String] name of the PodPreset
    # @param namespace [String] object name and auth scope, such as for teams and projects
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    ...
    # @return [V1Status]
    def delete_namespaced_pod_preset(name, namespace, opts = {})
      data, _status_code, _headers = delete_namespaced_pod_preset_with_http_info(name, namespace, opts)
      data
    end
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [Array<(V1Status, Integer, Hash)>] V1Status data, response status code and response headers
    def delete_namespaced_pod_preset_with_http_info(name, namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.delete_namespaced_pod_preset ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SettingsV1alpha1Api.delete_namespaced_pod_preset"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.delete_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#delete_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.get_api_resources ...'
      end
      # resource path
      local_var_path = '/apis/settings.k8s.io/v1alpha1/'
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.get_api_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#get_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_namespaced_pod_preset(namespace, opts = {})
      data, _status_code, _headers = list_namespaced_pod_preset_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1PodPresetList, Integer, Hash)>] V1alpha1PodPresetList data, response status code and response headers
    def list_namespaced_pod_preset_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.list_namespaced_pod_preset ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1PodPresetList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.list_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#list_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [V1alpha1PodPresetList]
    def list_pod_preset_for_all_namespaces(opts = {})
      data, _status_code, _headers = list_pod_preset_for_all_namespaces_with_http_info(opts)
      data
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1PodPresetList, Integer, Hash)>] V1alpha1PodPresetList data, response status code and response headers
    def list_pod_preset_for_all_namespaces_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.list_pod_preset_for_all_namespaces ...'
      end
      # resource path
      local_var_path = '/apis/settings.k8s.io/v1alpha1/podpresets'
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.list_pod_preset_for_all_namespaces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#list_pod_preset_for_all_namespaces\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1PodPreset]
    def patch_namespaced_pod_preset(name, namespace, body, opts = {})
      data, _status_code, _headers = patch_namespaced_pod_preset_with_http_info(name, namespace, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1PodPreset, Integer, Hash)>] V1alpha1PodPreset data, response status code and response headers
    def patch_namespaced_pod_preset_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.patch_namespaced_pod_preset ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SettingsV1alpha1Api.patch_namespaced_pod_preset"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SettingsV1alpha1Api.patch_namespaced_pod_preset"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.patch_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#patch_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1alpha1PodPreset]
    def read_namespaced_pod_preset(name, namespace, opts = {})
      data, _status_code, _headers = read_namespaced_pod_preset_with_http_info(name, namespace, opts)
      data
    end
    ...
    # @option opts [Boolean] :export Should this value be exported.  Export strips fields that a user can not specify.
    # @return [Array<(V1alpha1PodPreset, Integer, Hash)>] V1alpha1PodPreset data, response status code and response headers
    def read_namespaced_pod_preset_with_http_info(name, namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.read_namespaced_pod_preset ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SettingsV1alpha1Api.read_namespaced_pod_preset"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.read_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#read_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1PodPreset]
    def replace_namespaced_pod_preset(name, namespace, body, opts = {})
      data, _status_code, _headers = replace_namespaced_pod_preset_with_http_info(name, namespace, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1PodPreset, Integer, Hash)>] V1alpha1PodPreset data, response status code and response headers
    def replace_namespaced_pod_preset_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsV1alpha1Api.replace_namespaced_pod_preset ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SettingsV1alpha1Api.replace_namespaced_pod_preset"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SettingsV1alpha1Api.replace_namespaced_pod_preset"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"SettingsV1alpha1Api.replace_namespaced_pod_preset",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsV1alpha1Api#replace_namespaced_pod_preset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
