...
module Kubernetes
  class PolicyV1beta1Api
    ...
    # @param body [V1beta1PodDisruptionBudget] 
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1beta1PodDisruptionBudget, Integer, Hash)>] V1beta1PodDisruptionBudget data, response status code and response headers
    def create_namespaced_pod_disruption_budget_with_http_info(namespace, body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1PodDisruptionBudget'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.create_namespaced_pod_disruption_budget",
    ...
    # @param body [PolicyV1beta1PodSecurityPolicy] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :include_uninitialized If true, partially initialized resources are included in the response.
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(PolicyV1beta1PodSecurityPolicy, Integer, Hash)>] PolicyV1beta1PodSecurityPolicy data, response status code and response headers
    def create_pod_security_policy_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PolicyV1beta1PodSecurityPolicy'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.create_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_collection_namespaced_pod_disruption_budget_with_http_info(namespace, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.delete_collection_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_collection_pod_security_policy_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.delete_collection_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.delete_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_pod_security_policy_with_http_info(name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.delete_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_api_resources_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.get_api_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1PodDisruptionBudgetList, Integer, Hash)>] V1beta1PodDisruptionBudgetList data, response status code and response headers
    def list_namespaced_pod_disruption_budget_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1PodDisruptionBudgetList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.list_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_pod_disruption_budget_for_all_namespaces_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.list_pod_disruption_budget_for_all_namespaces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(PolicyV1beta1PodSecurityPolicyList, Integer, Hash)>] PolicyV1beta1PodSecurityPolicyList data, response status code and response headers
    def list_pod_security_policy_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PolicyV1beta1PodSecurityPolicyList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.list_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def patch_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.patch_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def patch_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.patch_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def patch_pod_security_policy_with_http_info(name, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.patch_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.read_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.read_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_pod_security_policy_with_http_info(name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.read_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def replace_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.replace_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def replace_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.replace_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def replace_pod_security_policy_with_http_info(name, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1beta1Api.replace_pod_security_policy",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
