...
module Kubernetes
  class AdmissionregistrationV1alpha1Api
    ...
    # @param body [V1alpha1InitializerConfiguration] 
    ...
    def create_initializer_configuration(body, opts = {})
      data, _status_code, _headers = create_initializer_configuration_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1InitializerConfiguration, Integer, Hash)>] V1alpha1InitializerConfiguration data, response status code and response headers
    def create_initializer_configuration_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.create_initializer_configuration ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AdmissionregistrationV1alpha1Api.create_initializer_configuration"
      end
      # resource path
      local_var_path = '/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1InitializerConfiguration'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.create_initializer_configuration",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#create_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [V1Status]
    def delete_collection_initializer_configuration(opts = {})
      data, _status_code, _headers = delete_collection_initializer_configuration_with_http_info(opts)
      data
    end
    ...
    def delete_collection_initializer_configuration_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.delete_collection_initializer_configuration ...'
      end
      # resource path
      local_var_path = '/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations'
      ...
      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.delete_collection_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#delete_collection_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # delete an InitializerConfiguration
    # @param name [String] name of the InitializerConfiguration
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    ...
    # @return [V1Status]
    def delete_initializer_configuration(name, opts = {})
      data, _status_code, _headers = delete_initializer_configuration_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [Array<(V1Status, Integer, Hash)>] V1Status data, response status code and response headers
    def delete_initializer_configuration_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.delete_initializer_configuration ...'
      end
      ...
      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.delete_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#delete_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_initializer_configuration(opts = {})
      data, _status_code, _headers = list_initializer_configuration_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1InitializerConfigurationList, Integer, Hash)>] V1alpha1InitializerConfigurationList data, response status code and response headers
    def list_initializer_configuration_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.list_initializer_configuration ...'
      end
      # resource path
      local_var_path = '/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1InitializerConfigurationList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.list_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#list_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1InitializerConfiguration]
    def patch_initializer_configuration(name, body, opts = {})
      data, _status_code, _headers = patch_initializer_configuration_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1InitializerConfiguration, Integer, Hash)>] V1alpha1InitializerConfiguration data, response status code and response headers
    def patch_initializer_configuration_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.patch_initializer_configuration ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling AdmissionregistrationV1alpha1Api.patch_initializer_configuration"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.patch_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#patch_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1alpha1InitializerConfiguration]
    def read_initializer_configuration(name, opts = {})
      data, _status_code, _headers = read_initializer_configuration_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [Boolean] :export Should this value be exported.  Export strips fields that a user can not specify.
    # @return [Array<(V1alpha1InitializerConfiguration, Integer, Hash)>] V1alpha1InitializerConfiguration data, response status code and response headers
    def read_initializer_configuration_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.read_initializer_configuration ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
      ...
      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.read_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#read_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1InitializerConfiguration]
    def replace_initializer_configuration(name, body, opts = {})
      data, _status_code, _headers = replace_initializer_configuration_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1InitializerConfiguration, Integer, Hash)>] V1alpha1InitializerConfiguration data, response status code and response headers
    def replace_initializer_configuration_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdmissionregistrationV1alpha1Api.replace_initializer_configuration ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling AdmissionregistrationV1alpha1Api.replace_initializer_configuration"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"AdmissionregistrationV1alpha1Api.replace_initializer_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdmissionregistrationV1alpha1Api#replace_initializer_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
