  ...
  class StorageV1beta1Api
    ...
    def create_volume_attributes_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.create_volume_attributes_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.create_volume_attributes_class"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.create_volume_attributes_class",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#create_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_collection_volume_attributes_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_collection_volume_attributes_class ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses'
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.delete_collection_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_collection_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_volume_attributes_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_volume_attributes_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.delete_volume_attributes_class"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.delete_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_volume_attributes_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.list_volume_attributes_class ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses'
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.list_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#list_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_volume_attributes_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.patch_volume_attributes_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.patch_volume_attributes_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.patch_volume_attributes_class"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.patch_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#patch_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_volume_attributes_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.read_volume_attributes_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.read_volume_attributes_class"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.read_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#read_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_volume_attributes_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.replace_volume_attributes_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.replace_volume_attributes_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.replace_volume_attributes_class"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.replace_volume_attributes_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#replace_volume_attributes_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
