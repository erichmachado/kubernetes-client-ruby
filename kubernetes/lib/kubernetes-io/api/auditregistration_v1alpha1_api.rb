...
module Kubernetes
  class AuditregistrationV1alpha1Api
    ...
    def create_audit_sink(body, opts = {})
      data, _status_code, _headers = create_audit_sink_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1AuditSink, Integer, Hash)>] V1alpha1AuditSink data, response status code and response headers
    def create_audit_sink_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.create_audit_sink ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AuditregistrationV1alpha1Api.create_audit_sink"
      end
      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/auditsinks'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1AuditSink'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.create_audit_sink",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#create_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # delete an AuditSink
    # @param name [String] name of the AuditSink
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    ...
    # @return [V1Status]
    def delete_audit_sink(name, opts = {})
      data, _status_code, _headers = delete_audit_sink_with_http_info(name, opts)
      data
    end
    ...
    def delete_audit_sink_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.delete_audit_sink ...'
      end
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.delete_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#delete_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1Status]
    def delete_collection_audit_sink(opts = {})
      data, _status_code, _headers = delete_collection_audit_sink_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @return [Array<(V1Status, Integer, Hash)>] V1Status data, response status code and response headers
    def delete_collection_audit_sink_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.delete_collection_audit_sink ...'
      end
      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/auditsinks'
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.delete_collection_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#delete_collection_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.get_api_resources ...'
      end
      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/'
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.get_api_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#get_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_audit_sink(opts = {})
      data, _status_code, _headers = list_audit_sink_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1AuditSinkList, Integer, Hash)>] V1alpha1AuditSinkList data, response status code and response headers
    def list_audit_sink_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.list_audit_sink ...'
      end
      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/auditsinks'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1alpha1AuditSinkList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.list_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#list_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1AuditSink]
    def patch_audit_sink(name, body, opts = {})
      data, _status_code, _headers = patch_audit_sink_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1AuditSink, Integer, Hash)>] V1alpha1AuditSink data, response status code and response headers
    def patch_audit_sink_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.patch_audit_sink ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.patch_audit_sink"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.patch_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#patch_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1alpha1AuditSink]
    def read_audit_sink(name, opts = {})
      data, _status_code, _headers = read_audit_sink_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [Boolean] :export Should this value be exported.  Export strips fields that a user can not specify.
    # @return [Array<(V1alpha1AuditSink, Integer, Hash)>] V1alpha1AuditSink data, response status code and response headers
    def read_audit_sink_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.read_audit_sink ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.read_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#read_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [V1alpha1AuditSink]
    def replace_audit_sink(name, body, opts = {})
      data, _status_code, _headers = replace_audit_sink_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1AuditSink, Integer, Hash)>] V1alpha1AuditSink data, response status code and response headers
    def replace_audit_sink_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuditregistrationV1alpha1Api.replace_audit_sink ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.replace_audit_sink"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"AuditregistrationV1alpha1Api.replace_audit_sink",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuditregistrationV1alpha1Api#replace_audit_sink\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
