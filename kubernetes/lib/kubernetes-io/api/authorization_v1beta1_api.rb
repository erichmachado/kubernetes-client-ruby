...
module Kubernetes
  class AuthorizationV1beta1Api
    ...
    def create_namespaced_local_subject_access_review_with_http_info(namespace, body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1LocalSubjectAccessReview'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuthorizationV1beta1Api.create_namespaced_local_subject_access_review",
    ...
    def create_self_subject_access_review_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1SelfSubjectAccessReview'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuthorizationV1beta1Api.create_self_subject_access_review",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def create_self_subject_rules_review_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1SelfSubjectRulesReview'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuthorizationV1beta1Api.create_self_subject_rules_review",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def create_subject_access_review_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1SubjectAccessReview'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"AuthorizationV1beta1Api.create_subject_access_review",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_api_resources_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"AuthorizationV1beta1Api.get_api_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
