...
module Kubernetes
  class SchedulingV1beta1Api
    ...
    # @param body [V1beta1PriorityClass] 
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1beta1PriorityClass, Integer, Hash)>] V1beta1PriorityClass data, response status code and response headers
    def create_priority_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.create_priority_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SchedulingV1beta1Api.create_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1beta1/priorityclasses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1PriorityClass'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.create_priority_class",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#create_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_collection_priority_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.delete_collection_priority_class ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1beta1/priorityclasses'
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.delete_collection_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#delete_collection_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_priority_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.delete_priority_class ...'
      end
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.delete_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#delete_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.get_api_resources ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1beta1/'
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.get_api_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#get_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1PriorityClassList, Integer, Hash)>] V1beta1PriorityClassList data, response status code and response headers
    def list_priority_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.list_priority_class ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1beta1/priorityclasses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1beta1PriorityClassList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.list_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#list_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_priority_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.patch_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1beta1Api.patch_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.patch_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#patch_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_priority_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.read_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.read_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#read_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_priority_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1beta1Api.replace_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1beta1Api.replace_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1beta1Api.replace_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1beta1Api#replace_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
