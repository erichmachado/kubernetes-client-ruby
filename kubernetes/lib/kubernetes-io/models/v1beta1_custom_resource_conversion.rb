...
module Kubernetes
  ...
  class V1beta1CustomResourceConversion
    ...
    attr_accessor :webhook_client_config
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1beta1CustomResourceConversion` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1beta1CustomResourceConversion`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'webhook_client_config')
        self.webhook_client_config = attributes[:'webhook_client_config']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          strategy == o.strategy &&
          webhook_client_config == o.webhook_client_config
    end
    ...
    def hash
      [strategy, webhook_client_config].hash
    end
