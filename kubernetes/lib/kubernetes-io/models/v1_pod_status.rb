...
module Kubernetes
  ...
  class V1PodStatus
    ...
    def hash
      [conditions, container_statuses, ephemeral_container_statuses, host_ip, host_ips, init_container_statuses, message, nominated_node_name, phase, pod_ip, pod_ips, qos_class, reason, resize, resource_claim_statuses, start_time].hash
    end
