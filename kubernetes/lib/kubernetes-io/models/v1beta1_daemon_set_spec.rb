...
module Kubernetes
  ...
  class V1beta1DaemonSetSpec
    ...
    attr_accessor :template_generation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1beta1DaemonSetSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1beta1DaemonSetSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'template_generation')
        self.template_generation = attributes[:'template_generation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          selector == o.selector &&
          template == o.template &&
          template_generation == o.template_generation &&
    ...
    def hash
      [min_ready_seconds, revision_history_limit, selector, template, template_generation, update_strategy].hash
    end
