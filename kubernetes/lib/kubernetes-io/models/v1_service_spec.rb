...
module Kubernetes
  ...
  class V1ServiceSpec
    ...
    def hash
      [cluster_ip, external_ips, external_name, external_traffic_policy, health_check_node_port, load_balancer_ip, load_balancer_source_ranges, ports, publish_not_ready_addresses, selector, session_affinity, session_affinity_config, type].hash
    end
