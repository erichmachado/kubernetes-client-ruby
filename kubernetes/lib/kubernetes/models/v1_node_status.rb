...
module Kubernetes
  ...
  class V1NodeStatus
    ...
    def hash
      [addresses, allocatable, capacity, conditions, config, daemon_endpoints, features, images, node_info, phase, runtime_handlers, volumes_attached, volumes_in_use].hash
    end
