  ...
  class V1alpha3DeviceClassSpec
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1alpha3DeviceClassSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1alpha3DeviceClassSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'suitable_nodes')
        self.suitable_nodes = attributes[:'suitable_nodes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          suitable_nodes == o.suitable_nodes
    end
    ...
    def hash
      [config, selectors, suitable_nodes].hash
    end
